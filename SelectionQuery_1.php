            ...
            <div class="container">
                ...
                <div class="row">  
                    ...
                    <div class="col-md-3">
                        ...
                        <?php
                        //$section = "councildistrict";
                        //$add = "true";
                        //include './GenericSQLQuery.php?sectionID=councildistrict&add=false';
                        include './GenericSQLQuery.php';
                        build("CouncilDistrict","false");
                        ?>
...
<!-- <p><a class="btn btn-default" href="#" role="button">View details &raquo;</a></p> -->
            ...
            <script>
                            ...
                            function createURLcall(parm)
                            {
                                ...
                                openme = "DownloadcsvFilefromDB.php?mindate=" + startdate + "&maxdate=" + enddate + "&" + parm + "=" + val;
                            ...
                            function createURLBulkCall(parm)
                            {
                                ...
                                getdates();
                                //var val = document.getElementById(parm).value;
                                openme = "DownloadcsvFilefromDB.php?mindate=" + startdate + "&maxdate=" + enddate + parmlist;
                            ...
                            function msgme() {
                                ...
                                document.getElementById("buttonhref").innerHTML = '<a class="btn btn-default" role="button" href="DownloadcsvFilefromDB.php?mindate=' + mymindate + '&maxdate=' + mymaxdate + '" >View details &raquo;</a>';
                            }
