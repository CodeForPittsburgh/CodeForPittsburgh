...
function BeginIncidentTable($sql_column) {
    ...
    if($sql_column === "councildistrict"){
        $column_name = "Council District";
    }
    if($sql_column === "zone"){
        $column_name = "Police Zone";
    }
    /* Display the beginning of the search results table. */
    $headings = array($column_name, "Year", "Section", "Description", "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec", "Count");
