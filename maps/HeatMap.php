...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <html>
        <head>
            ...
            <title>Police Blotter Heat Map Query 1.3.3</title>
        ...
        <body>
            ...
            <div class="jumbotron">  
                <h2><center>Police Blotter Heat Map Queries 1.3.3a</center></h2>
                <h4><center>Note: The row count is a weighted value, not actual incident count</center></h4>
                <h4><center>The weighted value will not display severity of actual incidents</center></h4>
                <h4><center>Google Heat Map has an array limit, so you might not see results</center></h4>
                <?php
        ...
        <script>
                            ...
                            function createURLBulkCall(parm)
                            {
                                ...
                                getdates();
                                //var val = document.getElementById(parm).value;
                                openme = "createHeatLatLng.php?mindate=" + startdate + "&maxdate=" + enddate + parmlist;
                            ...
                            function msgme() {
                                ...
                                document.getElementById("buttonhref").innerHTML = '<a class="btn btn-default" role="button" href="createHeatLatLng.php?mindate=' + mymindate + '&maxdate=' + mymaxdate + '" >View details &raquo;</a>';
                            }
