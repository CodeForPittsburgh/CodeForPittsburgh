...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <html>
        <head>
            ...
            <title>Police Blotter Generic Query</title>
        ...
        <body>
            ...
            <div class="jumbotron">  
                <h2><center>Police Blotter Generic Queries</center></h2>
        ...
        <script>
                            ...
                            function createURLcall(parm)
                            {
                                ...
                                openme = "../maps/createHeatLatLng.php?mindate=" + startdate + "&maxdate=" + enddate + "&" + parm + "=" + val;
                                //alert(openme);
