...
<html>
    <head>
        <title>Police Blotter Neighborhood Monthly Description Totals</title>
        <meta charset="UTF-8">
...
$sql = 'SELECT 
        d.neighborhood,d.Year, d.Section, d.description,
...
where de.descriptionid = i.descriptionid 
  ...
  ORDER BY 
           d.neighborhood,d.Year desc,d.description';
...
function BeginIncidentTable() {
    ...
    $headings = array("Neighborhood","Year", "Section", "Description", "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec", "Count");
