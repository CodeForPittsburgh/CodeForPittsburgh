    ...
    <body>
        ...
        <div class="row">
            <div class="col-sm-3">
                ...
                <a href="../maps/PPBXMLAddressMarkerCreate.php" class="btn btn-info btn-block" role="button">Open Blotter Group by Address</a>
                <a href="../maps/SelectionMapQuery.php" class="btn btn-info btn-block" role="button">Selection Map Query by Address</a>
                <a href="../maps/HeatMap.php" class="btn btn-info btn-block" role="button">Open Blotter Heat Map (R1.3.2a)</a> 
                <a href="../maps/PPBmapdetail.php" class="btn btn-info btn-block" role="button">Description Count Test</a> 
