...
<html lang="en">
    <head>
        ...
        <script type="text/javascript">
            ...
            var MapDataCreationFile = new Array;
            ...
            MapDataCreationFile[0]="./PoliceBlotterMap2_1.php";
            MapDataCreationFile[1]="./PoliceBlotterMap2_1.php";
            MapDataCreationFile[2]="./PoliceBlotterMap2_1.php";
...
// add police station locations
                setStationMarkers(map, stations);
                MarkerData(MapDataCreationFile[0]);

            }

            function MarkerData(filename)
            {
            ...
            function setStationMarkers(map, locations) {
        ...
        <div class="container">
            <div class="jumbotron">
                <h2 class="text-center">Pittsburgh Police Blotter</h2>
                 <img src="./img/codeforpghlogowithtype.png" alt="CodeForPittsburgh" style="width:60px;height:22px;">
            </div>
            <div class="row">
