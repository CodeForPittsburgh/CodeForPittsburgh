...
<html>
    <head>
        <title>Police Blotter Zone Monthly Description Totals</title>
        <meta charset="UTF-8">
...
$sql = 'SELECT 
        d.zone,d.Year, d.Section, d.description,
...
where de.descriptionid = i.descriptionid
  ...
  ORDER BY 
           d.zone,d.Year desc,d.description';
...
function BeginIncidentTable() {
    ...
    $headings = array("Police Zone","Year", "Section", "Description", "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec", "Count");
